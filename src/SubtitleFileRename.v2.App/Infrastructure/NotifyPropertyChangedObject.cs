...
namespace SubtitleFileRename.v2.App
{
    public abstract class NotifyPropertyChangedObject : INotifyPropertyChanged
    {
        ...
        protected virtual bool SetProperty<T>(ref T store, T value, [CallerMemberName] string propertyName = "", Action<T> onChanged = null, Func<T, T, bool> validateFunc = null, bool overwrite = false)
        {
